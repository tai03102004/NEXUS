                            ...
                            <div className="align-center flex justify-center gap-2 pt-px">
                                <div>
                                    <div className="h-10 w-full flex-row items-center rounded-lg border border-[#f1f1f166] bg-dark-gunmetal-400 dk:w-56 mb:h-7 mb:max-w-[177px] flex">
                                        <input placeholder="Search" className="h-full w-full flex-grow border border-none bg-transparent pl-[15px] text-2sm font-normal leading-normal text-white placeholder-neutral-100 outline-none mb:text-sm mb:pl-2.5"/>
